...
var qrcode = function() {
    ...
    function a(h, b) {
        ...
        this.__defineGetter__("DataCodewords", function() { return this.dataCodewords })
    }
    ...
    function f(h, b, e) {
        ...
        this.__defineGetter__("NumBlocks",
            function() { for (var d = 0, c = 0; c < this.ecBlocks.length; c++) d += this.ecBlocks[c].length; return d });
    ...
    function Q(h) {
        ...
        this.calculateModuleSize = function(b, e, d) { return (this.calculateModuleSizeOneWay(b, e) + this.calculateModuleSizeOneWay(b, d)) / 2 };
        ...
        this.sampleGrid = function(b, e, d) { return F.sampleGrid3(b, d, e) };
    ...
    function I(h, b) {
        ...
        this.get_Renamed = function(d, c) { return 0 != (u(this.bits[c * this.rowSize + (d >> 5)], d & 31) & 1) };
        this.set_Renamed = function(d, c) {
            this.bits[c * this.rowSize +
                (d >> 5)] |= 1 << (d & 31)
        };
        this.flip = function(d, c) { this.bits[c * this.rowSize + (d >> 5)] ^= 1 << (d & 31) };
        this.clear = function() { for (var d = this.bits.length, c = 0; c < d; c++) this.bits[c] = 0 };
    ...
    function T(a) {
        ...
        this.copyBit = function(e, d, c) { return this.bitMatrix.get_Renamed(e, d) ? c << 1 | 1 : c << 1 };
    ...
    function w(a, b) {
        ...
        if (1 < e && 0 == b[0]) {
            ...
            else { this.coefficients = Array(e - d); for (e = 0; e < this.coefficients.length; e++) this.coefficients[e] = 0; for (e = 0; e < this.coefficients.length; e++) this.coefficients[e] = b[d + e] }
        } else this.coefficients = b;
        this.__defineGetter__("Zero",
            function() { return 0 == this.coefficients[0] });
        ...
        this.getCoefficient = function(c) { return this.coefficients[this.coefficients.length - 1 - c] };
        this.evaluateAt = function(c) {
            if (0 == c) return this.getCoefficient(0);
            var d = this.coefficients.length;
            if (1 == c) { for (var b = c = 0; b < d; b++) c = n.addOrSubtract(c, this.coefficients[b]); return c }
        ...
        this.multiply2 = function(c) { if (0 == c) return this.field.Zero; if (1 == c) return this; for (var d = this.coefficients.length, b = Array(d), e = 0; e < d; e++) b[e] = this.field.multiply(this.coefficients[e], c); return new w(this.field, b) };
        this.multiplyByMonomial = function(c,
            d) { if (0 > c) throw "System.ArgumentException"; if (0 == d) return this.field.Zero; for (var b = this.coefficients.length, e = Array(b + c), a = 0; a < e.length; a++) e[a] = 0; for (a = 0; a < b; a++) e[a] = this.field.multiply(this.coefficients[a], d); return new w(this.field, e) };
    ...
    function n(a) {
        ...
        this.exp = function(d) { return this.expTable[d] };
        this.log = function(d) { if (0 == d) throw "System.ArgumentException"; return this.logTable[d] };
        this.inverse = function(d) { if (0 == d) throw "System.ArithmeticException"; return this.expTable[255 - this.logTable[d]] };
    ...
    function u(a, b) { return 0 <= a ? a >> b : (a >> b) + (2 << ~b) }
    ...
    function S() {
        ...
        this.centerFromEnd = function(a, b) { return b - a[4] - a[3] - a[2] / 2 };
    ...
    function M(a, b, e) {
        ...
        this.__defineGetter__("EstimatedModuleSize",
            function() { return this.estimatedModuleSize });
        this.__defineGetter__("Count", function() { return this.count });
    ...
    function R(a, b, e, d, c, f, l) {
        ...
        this.centerFromEnd = function(c, d) { return d - c[2] - c[1] / 2 };
    ...
    function X(a, b, e) {
        ...
        this.NextMode = function() { return this.blockPointer > this.blocks.length - this.numErrorCorrectionCode - 2 ? 0 : this.getNextBits(4) };
        this.getDataLength = function(b) { for (var c = 0; 1 != b >> c;) c++; return this.getNextBits(g.sizeOfDataLengthInfo[this.dataLengthMode][c]) };
    ...
    var F = {
        ...
        sampleGrid3: function(a, b, e) {
            for (var d = new I(b), c = Array(b << 1), h = 0; h < b; h++) {
                ...
                try { for (k = 0; k < f; k += 2) a[Math.floor(c[k]) + g.width * Math.floor(c[k + 1])] && d.set_Renamed(k >> 1, h) } catch (q) { throw "Error.checkAndNudgePoints"; }
            }
            return d
        },
    ...
    k.getVersionForNumber = function(a) { if (1 > a || 40 < a) throw "ArgumentException"; return k.VERSIONS[a - 1] };
    ...
    z.quadrilateralToSquare = function(a, b, e, d, c, f, g, m) { return this.squareToQuadrilateral(a, b, e, d, c, f, g, m).buildAdjoint() };
    var N = [
            [21522, 0],
            [20773, 1],
            [24188, 2],
    ...
    r.numBitsDiffering = function(a, b) { a ^= b; return B[a & 15] + B[u(a, 4) & 15] + B[u(a, 8) & 15] + B[u(a, 12) & 15] + B[u(a, 16) & 15] + B[u(a, 20) & 15] + B[u(a, 24) & 15] + B[u(a, 28) & 15] };
    ...
    C.forBits = function(a) { if (0 > a || a >= O.length) throw "ArgumentException"; return O[a] };
    var Y = new C(0, 1, "L"),
        Z = new C(1, 0, "M"),
        aa = new C(2, 3, "Q"),
        ba = new C(3, 2, "H"),
    ...
    var H = { forReference: function(a) { if (0 > a || 7 < a) throw "System.ArgumentException"; return H.DATA_MASKS[a] } };
    H.DATA_MASKS = [new function() {
            this.unmaskBitMatrix = function(a, b) {
                for (var e = 0; e < b; e++)
                    for (var d = 0; d < b; d++) this.isMasked(e, d) && a.flip(d, e)
            };
            this.isMasked = function(a, b) { return 0 == (a + b & 1) }
        }, new function() {
            this.unmaskBitMatrix = function(a, b) {
                for (var e = 0; e < b; e++)
                    for (var d = 0; d < b; d++) this.isMasked(e, d) && a.flip(d, e)
            };
            this.isMasked = function(a, b) { return 0 == (a & 1) }
        },
        new function() {
            this.unmaskBitMatrix = function(a, b) {
                for (var e = 0; e < b; e++)
            ...
            this.isMasked = function(a, b) { return 0 == b % 3 }
        },
        new function() {
            this.unmaskBitMatrix = function(a, b) {
                for (var e = 0; e < b; e++)
            ...
            this.isMasked = function(a, b) { return 0 == (a + b) % 3 }
        },
        new function() {
            this.unmaskBitMatrix = function(a, b) {
                for (var e = 0; e < b; e++)
        ...
        new function() {
            ...
            this.isMasked = function(a, b) { var e = a * b; return 0 == (e & 1) + e % 3 }
        },
        new function() {
            this.unmaskBitMatrix = function(a, b) {
                for (var e = 0; e < b; e++)
            ...
            this.isMasked = function(a, b) { var e = a * b; return 0 == ((e & 1) + e % 3 & 1) }
        },
        new function() {
            this.unmaskBitMatrix = function(a, b) {
                for (var e = 0; e < b; e++)
    ...
    n.addOrSubtract = function(a, b) { return a ^ b };
    var E = {};
    ...
    E.correctErrors = function(a, b) {
        ...
        e = a.length - b;
        try { E.rsDecoder.decode(d, e) } catch (p) { throw p; }
    ...
    var g = {
            ...
            captureToCanvas: function() {
                if (g.gUM) try {
                    if (0 == g.video.videoWidth) setTimeout(g.captureToCanvas, 500);
                        ...
                        try { g.decode() } catch (h) { console.log(h), setTimeout(g.captureToCanvas, 500) }
                    }
                } catch (h) { console.log(h), setTimeout(g.captureToCanvas, 500) }
            },
            setWebcam: function(a) {
                ...
                } catch (d) { console.log(d) } else console.log("no navigator.mediaDevices.enumerateDevices");
            ...
            decode: function(a) {
                if (0 == arguments.length) {
                    if (g.canvas_qr2) { var b = g.canvas_qr2; var e = g.qrcontext2 } else b = document.getElementById("qr-canvas"), e = b.getContext("2d");
                    g.width = b.width;
                    g.height = b.height;
                ...
                d.onload = function() {
                    ...
                    try { g.result = g.process(b) } catch (y) { console.log(y), g.result = Error("error decoding QR Code") }
                    null != g.callback && g.callback(g.result)
                };
                d.onerror = function() { null != g.callback && g.callback(Error("Failed to load the image")) };
                d.src = a
            },
            isUrl: function(a) { return /(ftp|http|https):\/\/(\w+:{0,1}\w*@)?(\S+)(:[0-9]+)?(\/|\/([\w#!:.?+=&%@!\-\/]))?/.test(a) },
            decode_url: function(a) {
                var b = "";
                try { b = escape(a) } catch (e) { console.log(e), b = a }
                a = "";
                try { a = decodeURIComponent(b) } catch (e) { console.log(e), a = b }
                return a
            },
            decode_utf8: function(a) { return g.isUrl(a) ? g.decode_url(a) : a },
            process: function(a) {
            ...
            getMiddleBrightnessPerArea: function(a) {
                for (var b = Math.floor(g.width / 4), e = Math.floor(g.height / 4), d = Array(4), c = 0; 4 > c; c++) { d[c] = Array(4); for (var f = 0; 4 > f; f++) d[c][f] = [0, 0] }
                for (c = 0; 4 > c; c++)
                    for (f =
                        0; 4 > f; f++) {
                        d[f][c][0] = 255;
